...
from qiskit_utils.algorithms import OptimizationResult
from qiskit_utils.exceptions import QiskitOptimizationError
from qiskit_utils.problems import QuadraticProgram
from qiskit_utils.translators import from_docplex_mp
...
class Tsp(GraphOptimizationApplication):
    ...
    def to_quadratic_program(self) -> QuadraticProgram:
        ...
        :class:`~qiskit_utils.problems.QuadraticProgram`

        Returns:
            The :class:`~qiskit_utils.problems.QuadraticProgram` created
