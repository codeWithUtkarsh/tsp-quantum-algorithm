...
class OptimizationResult:
    ...
    Examples:
        >>> from qiskit_utils import QuadraticProgram
        >>> from qiskit_utils.algorithms import CplexOptimizer
    ...
    def _prepare_converters(
        ...
        Args:
            converters: The converters to use for converting a problem into a different form.
                ...
                :class:`~qiskit_utils.converters.QuadraticProgramToQubo` will be used.
            penalty: The penalty factor used in the default
                :class:`~qiskit_utils.converters.QuadraticProgramToQubo` converter
        ...
        Raises:
            ...
            :class:`~qiskit_utils.converters.QuadraticProgramConverter type.
        """
