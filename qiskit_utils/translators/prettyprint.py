...
from qiskit_utils import INFINITY, QiskitOptimizationError
from qiskit_utils.problems import (
    LinearExpression,
    QuadraticExpression,
    QuadraticObjective,
    QuadraticProgram,
...
def prettyprint(quadratic_program: QuadraticProgram, wrap: int = 80) -> str:
    """Translate a :class:`~qiskit_utils.problems.QuadraticProgram` into a pretty-printed string.
